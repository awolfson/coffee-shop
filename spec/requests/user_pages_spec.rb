...
describe "User pages" do
  ...
  describe "following/followers" do
    ...
    describe "followed users" do
      ...
      it { should have_title_tag(full_title('Following')) }
      it { should have_h3_tag('Following') }
    ...
    describe "followers" do
      ...
      it { should have_title_tag(full_title('Followers')) }
      it { should have_h3_tag('Followers') }
